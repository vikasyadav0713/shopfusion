	...
	return (
		<>
			<motion.article
				...
				className="group flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-[5px] dark:shadow-[0_10px_30px_rgba(0,0,0,0.5)] cursor-pointer"
			>
